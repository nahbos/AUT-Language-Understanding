# Run in colab   !wget https://www.comp.nus.edu.sg/%7Ekanmy/courses/practicalNLP_2008/packages/conlleval.pl  
# 
# To evaaluate model call conlleval(predicted_labels, true_labels, sorted_labels,'results.txt')
#
# predicted_labels is a list of lists
#
# true_labels is a list of lists
#
# sorted_labels is a list of all unique labels which are sorted
#
